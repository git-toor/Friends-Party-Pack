...
prompt = f"{style}, an orange tabby cat dressed as Dwight Schrute, Dwight's side-part hairstyle, round glasses, yellow mustard colored short sleeve shirt, brown pants, holding a megaphone and shouting at another cat dressed as Jim who looks smug, office background with desks and computers"

OUTPUT_PATH = os.path.abspath("../../client/public/art/_test_dwight.webp")
...
workflow = {
    ...
    "ksampler": {"class_type": "KSampler", "inputs": {"seed": 9997, "steps": 28, "cfg": 1.0, "sampler_name": "euler", "scheduler": "normal", "denoise": 1.0, "model": ["ckpt", 0], "positive": ["pos", 0], "negative": ["neg", 0], "latent_image": ["empty", 0]}},
