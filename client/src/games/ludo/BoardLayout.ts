...
// ─── Main track (52 tiles, clockwise from Blue's start) ─────────
// Generated by rotating base path so Blue's entry (0,8) is index 0.
...
// Rotate so Blue's entry (old[13]) becomes new[0]
// Blue start = tile 0, Red start = tile 13, Green = 26, Yellow = 39
